...
export const GITHUB_REPO =
  'https://github.com/cliveb986-cpu/surroundsound-workbench'
...
export const DOWNLOAD_URL =
  'https://github.com/cliveb986-cpu/surroundsound-workbench/releases/latest/download/SurroundWorkbench-standalone.zip'
