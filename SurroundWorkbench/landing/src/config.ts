...
export const GITHUB_REPO =
  'https://github.com/audio-tumbleweed/surroundsound-workbench'
...
export const DOWNLOAD_URL =
  'https://github.com/audio-tumbleweed/surroundsound-workbench/releases/latest/download/SurroundWorkbench-standalone.zip'
